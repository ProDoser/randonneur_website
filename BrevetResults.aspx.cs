    ...
    
{
    ...
    //SEARCH LIST
    private void createSearchBrevetList(String distance, String year, String location)
    {
        List<Brevet> brevetList = brevetDAO.SearchBrevets(distance, year, location);
        ListBoxBrevets.Items.Clear();
        if (brevetList == null)
        {
            showErrorMessage("DATABASE TEMPORARILY OUT OF USE (see Database.log)");
